...
int snd_MusicDevice,    // current music card # (index to dmxCodes)
        ...
        snd_MaxVolume2,      // maximum volume for sound
        snd_MusicVolume2;    // maximum volume for music
...
void I_SetMusicVolume(int volume)
{
  ...
  snd_MusicVolume2 = volume;
}

void I_SetSfxVolume(int volume)
{
  snd_MaxVolume2 = volume*8; // THROW AWAY?
}
...
#endif
  rc = MUS_PlaySong(handle, snd_MusicVolume2);
#ifdef SNDDEBUG
